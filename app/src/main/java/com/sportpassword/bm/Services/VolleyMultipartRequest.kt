...
class VolleyMultipartRequest : Request<NetworkResponse> {
    ...
    private var mHeaders: kotlin.collections.Map<String, String>? = null
     ...
     */
    protected val byteData: kotlin.collections.Map<String, DataPart>?
     ...
     */
    constructor(url: String, headers: kotlin.collections.Map<String, String>,
    ...
    private fun textParse(dataOutputStream: DataOutputStream, params: kotlin.collections.Map<String, String>, encoding: String) {
        try {
     ...
     */
    @Throws(IOException::class)
    private fun dataParse(dataOutputStream: DataOutputStream, data: kotlin.collections.Map<String, DataPart>) {
